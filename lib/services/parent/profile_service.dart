  ...
  static Future<Map<String, dynamic>> getProfile() async {
    try {
      final response = await http.get(
        Uri.parse('${ServiceConstants.apiBase}/ortu/profile'),
        headers: {
  ...
  static Future<Map<String, dynamic>> updateAvatar(String imagePath) async {
    try {
      var request = http.MultipartRequest(
        'POST',
        Uri.parse('${ServiceConstants.apiBase}/ortu/profile/avatar'),
      );
  ...
  static Future<Map<String, dynamic>> changePassword({
    ...
    try {
      final response = await http.post(
        Uri.parse('${ServiceConstants.apiBase}/ortu/profile/password'),
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
          'Authorization': 'Bearer ${await AuthService.getToken()}',
